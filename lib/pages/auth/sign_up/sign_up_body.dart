...
import 'package:fixify_app/pages/models/user_role_model.dart';
        ...
        children: [
          ...
          pageIndex == 0
              ? Center(
                child: IconButton(
                icon: CircleAvatar(
                    backgroundColor: AppColors.primaryColor, child: Icon(Icons.arrow_forward, color: AppColors.whiteColor, size: 15,)),
                onPressed: () {
                  selectedRole == UserRole.customer
