...
class DashboardTechnicianCard extends StatelessWidget {
  ...
  const DashboardTechnicianCard({Key? key, required this.imageUrl, required this.time, required this.name, required this.location, required this.services}) : super(key: key);
